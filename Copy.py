...
#====================================================== Save images at given sensorvalue ==========================================#
ext='jpg'
dir_path = str('D:/Desktop/Nhom_Tri_Nhat/Images')
basename = datetime.datetime.now().strftime('%Y%m%d%H%M%S%f')
delay=1
...
#======================================== Recieve to PLC =====================================================#
            ...
            if (Ss0_2Value[0] == 10):
                cv2.imwrite('{}_{}.{}'.format(base_path, datetime.datetime.now().strftime('%Y%m%d%H%M%S%f'), ext), orig)   
            n+=1
